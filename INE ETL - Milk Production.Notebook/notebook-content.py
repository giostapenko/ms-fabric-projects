...
df = spark.read.option("multiline", "true").json("Files/data/ine_data/json/milk_production/*.json")
display(df)
...
final_df.createOrReplaceTempView("tb_ine_milk_production")
...
# MAGIC %%sql
# MAGIC CREATE TABLE tb_milk_production AS
# MAGIC SELECT *
# MAGIC 
