...
df = spark.read.option("multiline", "true").json("Files/data/ine_data/json/meat_production/*.json")
display(df)
...
final_df.createOrReplaceTempView("tb_ine_meat_production")
...
# MAGIC %%sql
# MAGIC CREATE TABLE tb_meat_production AS
# MAGIC SELECT *
# MAGIC 
# MAGIC FROM tb_ine_meat_production
...
# MAGIC %%sql
# MAGIC INSERT INTO tb_meat_production
# MAGIC 
